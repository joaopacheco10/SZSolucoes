...
def input-output param p-rd-opc  AS INTEGER                      no-undo.
...
c-fim-dat i-rd-opc bt-ok bt-cancelar bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS c-ini-emb c-fim-emb c-ini-res c-fim-res ~
c-ini-ped c-fim-ped c-ini-cli c-fim-cli c-ini-dat c-fim-dat i-rd-opc 
...
DEFINE VARIABLE i-rd-opc AS INTEGER INITIAL 3 
...
DEFINE FRAME F-Main
     ...
     i-rd-opc AT ROW 7.08 COL 17 NO-LABEL WIDGET-ID 28
     bt-ok AT ROW 8.38 COL 3
     bt-cancelar AT ROW 8.38 COL 14
     bt-ajuda AT ROW 8.38 COL 69
     "Op‡Æo:" VIEW-AS TEXT
          SIZE 6.86 BY .88 AT ROW 7.08 COL 10 WIDGET-ID 32
     RECT-1 AT ROW 8.17 COL 2
...
DO:
    ...
    assign p-emb-ini = input frame {&frame-name} c-ini-emb
           ...
           p-rd-opc  = input frame {&frame-name} i-rd-opc.
...
------------------------------------------------------------------------------*/
  DISPLAY c-ini-emb c-fim-emb c-ini-res c-fim-res c-ini-ped c-fim-ped c-ini-cli 
          c-fim-cli c-ini-dat c-fim-dat i-rd-opc 
  ...
  ENABLE RECT-1 IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 
         ...
         c-fim-ped c-ini-cli c-fim-cli c-ini-dat c-fim-dat i-rd-opc bt-ok 
...
------------------------------------------------------------------------------*/
  ...
  if p-rd-opc <> 0 then
      assign i-rd-opc:screen-value in frame {&frame-name} = string(p-rd-opc).
