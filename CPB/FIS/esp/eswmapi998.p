/**************************************************************************
**   Programa: esp/eswmapi998.p
**   Data    : Junho/2016
**   Autor   : Joao Pacheco
**   Objetivo: Gerenciamento da conexÆo ODBC - FIS
**   Versao..: 
**************************************************************************/

{include/i-prgvrs.i eswmapi998.p 2.06.00.000}
...
ObjConnection:open ( "data source=" + ODBC-DSN-FIS + ";server=" + ODBC-SERVER-FIS, ODBC-USERID-FIS, ODBC-PASSWD-FIS, 0 ) . 
...
/*    put unformatted
        '1 ODBC-SQL-STMT - ' ODBC-SQL-STMT skip.*/
    ...
    /*put unformatted
        '2 ODBC-SQL-STMT - ' ODBC-SQL-STMT skip.*/
    
    assign ODBC-SQL-STMT = ODBC-SQL-STMT + " VALUES (".
    
/*    put unformatted
        '3 ODBC-SQL-STMT - ' ODBC-SQL-STMT skip.*/
     
    do i = 1 to h-bf:num-fields:
        assign c-valor = h-bf:buffer-field(i):buffer-value.
        
/*        put unformatted
            'c-valor - ' c-valor skip.*/
...
/*        put unformatted
            '4 ODBC-SQL-STMT - ' ODBC-SQL-STMT skip.*/
