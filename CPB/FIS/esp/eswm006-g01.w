...
*******************************************************************************/
{include/i-prgvrs.i ESWM006-G01 2.06.00.001}
...
&Scoped-Define ENABLED-OBJECTS rt-button i_cod-canal-venda bt-ok bt-cancela ~
bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS i_cod-canal-venda 
...
DEFINE VARIABLE i_cod-canal-venda AS INTEGER FORMAT ">>9":U INITIAL 0 
     LABEL "Canal Venda" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME d-vapara
     i_cod-canal-venda AT ROW 1.83 COL 22.57 COLON-ALIGNED WIDGET-ID 2
     bt-ok AT ROW 3.71 COL 2.14
     bt-cancela AT ROW 3.71 COL 13
     bt-ajuda AT ROW 3.71 COL 41.86
     rt-button AT ROW 3.46 COL 1
     SPACE(0.28) SKIP(0.07)
...
DO:
FIND esp-conta-frete NO-LOCK
    WHERE esp-conta-frete.cod-canal-venda EQ INPUT FRAME {&FRAME-NAME} i_cod-canal-venda NO-ERROR.

IF NOT AVAILABLE esp-conta-frete THEN DO:
    {utp/ut-table.i mgesp esp-conta-frete 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(esp-conta-frete).
END.
...
------------------------------------------------------------------------------*/
  DISPLAY i_cod-canal-venda 
      WITH FRAME d-vapara.
  ENABLE rt-button i_cod-canal-venda bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESWM006-G01" "2.06.00.001"}
