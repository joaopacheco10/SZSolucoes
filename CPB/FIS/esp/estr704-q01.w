...
*******************************************************************************/
{include/i-prgvrs.i ESTR704-Q01 12.01.00.001}
...
def new global shared var gi-status-fatura as integer initial 1 no-undo.
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH esp-fatura-frete ~
      WHERE (mgcpb.esp-fatura-frete.ind-sit-fatura < 5 and gi-status-fatura <> 2) or ~
(mgcpb.esp-fatura-frete.ind-sit-fatura = 5 and gi-status-fatura = 2)  ~
 NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH esp-fatura-frete ~
      WHERE (mgcpb.esp-fatura-frete.ind-sit-fatura < 5 and gi-status-fatura <> 2) or ~
(mgcpb.esp-fatura-frete.ind-sit-fatura = 5 and gi-status-fatura = 2)  ~
 NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main esp-fatura-frete
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main esp-fatura-frete
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Where[1]         = "(mgcpb.esp-fatura-frete.ind-sit-fatura < 5 and gi-status-fatura <> 2) or
(mgcpb.esp-fatura-frete.ind-sit-fatura = 5 and gi-status-fatura = 2) 
"
