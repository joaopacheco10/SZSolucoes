...
DEFINE VARIABLE h_eswm005-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_eswm005-v01 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/eswm005-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_eswm005-v01 ).
       RUN set-position IN h_eswm005-v01 ( 2.79 , 1.43 ) NO-ERROR.
       /* Size in UIB:  ( 5.75 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/eswm005-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = esp/eswm005-z01.w,
                     ProgVaPara = esp/eswm005-g01.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_eswm005-q01 ).
       RUN set-position IN h_eswm005-q01 ( 1.29 , 65.72 ) NO-ERROR.
       /* Size in UIB:  ( 1.25 , 7.72 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_eswm005-v01. */
       RUN add-link IN adm-broker-hdl ( h_eswm005-q01 , 'Record':U , h_eswm005-v01 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_eswm005-v01 ).

       /* Links to SmartQuery h_eswm005-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_eswm005-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_eswm005-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_eswm005-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_eswm005-v01 ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESWM005" "2.06.00.001"}
