...
{include/i-prgvrs.i ESTR104-G01 12.01.00.001}
...
&Scoped-Define ENABLED-OBJECTS rt-button c_nome-transp c_ser-docto ~
c_nr-fatura bt-ok bt-cancela bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS c_nome-transp c_ser-docto c_nr-fatura 
...
DEFINE VARIABLE c_nome-transp AS CHARACTER FORMAT "x(12)":U 
     LABEL "Transportadora" 
     VIEW-AS FILL-IN 
     SIZE 12 BY .88 NO-UNDO.

DEFINE VARIABLE c_nr-fatura AS CHARACTER FORMAT "x(10)":U 
     LABEL "Nr Fatura" 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 NO-UNDO.

DEFINE VARIABLE c_ser-docto AS CHARACTER FORMAT "x(3)":U 
     LABEL "S‚rie" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME d-vapara
     c_nome-transp AT ROW 1 COL 30 COLON-ALIGNED WIDGET-ID 2
     c_ser-docto AT ROW 2 COL 30 COLON-ALIGNED WIDGET-ID 4
     c_nr-fatura AT ROW 3 COL 30 COLON-ALIGNED WIDGET-ID 6
...
DO:
FIND esp-fatura-frete NO-LOCK
    WHERE esp-fatura-frete.nome-transp EQ INPUT FRAME {&FRAME-NAME} c_nome-transp
      AND esp-fatura-frete.ser-docto EQ INPUT FRAME {&FRAME-NAME} c_ser-docto
      AND esp-fatura-frete.nr-fatura EQ INPUT FRAME {&FRAME-NAME} c_nr-fatura NO-ERROR.

IF NOT AVAILABLE esp-fatura-frete THEN DO:
    {utp/ut-table.i mgesp esp-fatura-frete 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(esp-fatura-frete).
END.
...
------------------------------------------------------------------------------*/
  DISPLAY c_nome-transp c_ser-docto c_nr-fatura 
      WITH FRAME d-vapara.
  ENABLE rt-button c_nome-transp c_ser-docto c_nr-fatura bt-ok bt-cancela 
         bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESTR704-G01" "12.01.00.001"}
