...
*******************************************************************************/
{include/i-prgvrs.i ESWM005-Z01 2.06.00.001}
...
DEFINE VARIABLE h_eswm005-b01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-zoom
     ...
     bt-ajuda AT ROW 15.38 COL 79
     rt-button AT ROW 15.13 COL 2
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Natur.Frete' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/eswm005-b01.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_eswm005-b01 ).
       RUN set-position IN h_eswm005-b01 ( 3.25 , 6.72 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 80.14 ) */

       /* Links to SmartBrowser h_eswm005-b01. */
       RUN add-link IN adm-broker-hdl ( h_eswm005-b01 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_eswm005-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESWM005-Z01" "2.06.00.001"}
