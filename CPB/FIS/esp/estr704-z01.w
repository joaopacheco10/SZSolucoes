...
{include/i-prgvrs.i ESTR704-Z01 12.01.00.001}
...
DEFINE VARIABLE h_estr704-b02 AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Fatura' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 1.17 , 2.00 ) NO-ERROR.
       RUN set-size IN h_folder ( 13.83 , 88.14 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/estr704-b02.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_estr704-b02 ).
       RUN set-position IN h_estr704-b02 ( 2.50 , 6.00 ) NO-ERROR.
       /* Size in UIB:  ( 12.25 , 80.14 ) */

       /* Links to SmartBrowser h_estr704-b02. */
       RUN add-link IN adm-broker-hdl ( h_estr704-b02 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_estr704-b02 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESTR704-Z01" "12.01.00.001"}
