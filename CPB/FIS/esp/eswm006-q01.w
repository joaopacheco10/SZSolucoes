...
*******************************************************************************/
{include/i-prgvrs.i ESWM006-Q01 2.06.00.001}
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH esp-conta-frete NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH esp-conta-frete NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main esp-conta-frete
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main esp-conta-frete
...
<FOREIGN-KEYS>
cod-canal-venda||y|mgesp.esp-conta-frete.cod-canal-venda
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "mgcpb.esp-conta-frete"
