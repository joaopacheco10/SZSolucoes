...
*******************************************************************************/
{include/i-prgvrs.i ESFT101-Q01 12.01.00.001}
...
&Scoped-define INTERNAL-TABLES es-param-gnre

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-param-gnre NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-param-gnre NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main es-param-gnre
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-param-gnre
