...
*******************************************************************************/
{include/i-prgvrs.i ESFT103-Q01 12.01.00.001}
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-conf-uf-gnre NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-conf-uf-gnre NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main es-conf-uf-gnre
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-conf-uf-gnre
