...
*******************************************************************************/
{include/i-prgvrs.i ESFT101-G01 12.01.00.001}
...
&Scoped-Define ENABLED-OBJECTS rt-button c_cod-estabel bt-ok bt-cancela ~
bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS c_cod-estabel 
...
DEFINE VARIABLE c_cod-estabel AS CHARACTER FORMAT "x(5)":U 
...
DEFINE FRAME d-vapara
     c_cod-estabel AT ROW 2 COL 30 COLON-ALIGNED WIDGET-ID 2
...
DO:
FIND es-param-gnre NO-LOCK
    WHERE es-param-gnre.cod-estabel EQ INPUT FRAME {&FRAME-NAME} c_cod-estabel NO-ERROR.

IF NOT AVAILABLE es-param-gnre THEN DO:
    {utp/ut-table.i mgesp es-param-gnre 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(es-param-gnre).
END.
...
------------------------------------------------------------------------------*/
  DISPLAY c_cod-estabel 
      WITH FRAME d-vapara.
  ENABLE rt-button c_cod-estabel bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESFT101-G01" "12.01.00.001"}
