...
*******************************************************************************/
{include/i-prgvrs.i ESCM104-B01 12.01.00.001}
...
&Scoped-define FIELDS-IN-QUERY-br-table es-acordo-faixa.num-faixa ~
es-acordo-faixa.desc-faixa es-acordo-faixa.limite-inicial ~
es-acordo-faixa.limite-final 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-table 
&Scoped-define QUERY-STRING-br-table FOR EACH es-acordo-faixa OF es-acordo-area-docto WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br-table OPEN QUERY br-table FOR EACH es-acordo-faixa OF es-acordo-area-docto WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-table B-table-Win _STRUCTURED
  QUERY br-table NO-LOCK DISPLAY
      es-acordo-faixa.num-faixa FORMAT ">9":U WIDTH 7.43
      es-acordo-faixa.desc-faixa FORMAT "x(35)":U WIDTH 36.43
      es-acordo-faixa.limite-inicial FORMAT ">>9.99":U WIDTH 8.43
      es-acordo-faixa.limite-final FORMAT ">>9.99":U WIDTH 8.43
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br-table
     _TblList          = "mgesp.es-acordo-faixa OF mgesp.es-acordo-area-docto"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > mgesp.es-acordo-faixa.num-faixa
"es-acordo-faixa.num-faixa" ? ? "integer" ? ? ? ? ? ? no ? no no "7.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > mgesp.es-acordo-faixa.desc-faixa
"es-acordo-faixa.desc-faixa" ? ? "character" ? ? ? ? ? ? no ? no no "36.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > mgesp.es-acordo-faixa.limite-inicial
"es-acordo-faixa.limite-inicial" ? ? "decimal" ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > mgesp.es-acordo-faixa.limite-final
"es-acordo-faixa.limite-final" ? ? "decimal" ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
DO:
    ...
    if can-find(first es-acordo-faixa-aprov where
                      es-acordo-faixa-aprov.cod-area  = es-acordo-faixa.cod-area   and
                      es-acordo-faixa-aprov.tp-docto  = es-acordo-faixa.tp-docto   and
                      es-acordo-faixa-aprov.num-faixa = es-acordo-faixa.num-faixa) then do:

        run utp/ut-msgs.p (input 'show',
                           input 17006,
                           input 'Aprovador Relacionado a Faixa').
