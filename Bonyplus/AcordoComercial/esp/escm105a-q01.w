...
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-acordo-faixa-aprov NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-acordo-faixa-aprov NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main es-acordo-faixa-aprov
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-acordo-faixa-aprov
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "mgesp.es-acordo-faixa-aprov"
