...
DEFINE FRAME f-main
     es-acordo-faixa.cod-area AT ROW 1.17 COL 25 COLON-ALIGNED WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 8 BY .88
     c-desc-area AT ROW 1.17 COL 33.14 COLON-ALIGNED NO-LABEL WIDGET-ID 14
     es-acordo-faixa.tp-docto AT ROW 2.17 COL 25 COLON-ALIGNED WIDGET-ID 12
          VIEW-AS FILL-IN 
          SIZE 3.43 BY .88
     c-desc-docto AT ROW 2.17 COL 28.57 COLON-ALIGNED NO-LABEL WIDGET-ID 16
     es-acordo-faixa.num-faixa AT ROW 3.17 COL 25 COLON-ALIGNED WIDGET-ID 10
          VIEW-AS FILL-IN 
          SIZE 3.43 BY .88
     es-acordo-faixa.desc-faixa AT ROW 3.17 COL 28.57 COLON-ALIGNED NO-LABEL WIDGET-ID 4
          VIEW-AS FILL-IN 
          SIZE 36.43 BY .88
     es-acordo-faixa.limite-inicial AT ROW 4.17 COL 25 COLON-ALIGNED WIDGET-ID 8
          VIEW-AS FILL-IN 
          SIZE 8 BY .88
     es-acordo-faixa.limite-final AT ROW 5.17 COL 25 COLON-ALIGNED WIDGET-ID 6
          VIEW-AS FILL-IN 
          SIZE 8 BY .88
...
/* SETTINGS FOR FILL-IN es-acordo-faixa.cod-area IN FRAME f-main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN es-acordo-faixa.desc-faixa IN FRAME f-main
   NO-ENABLE                                                            */
...
------------------------------------------------------------------------------*/
    ...
    if avail es-acordo-faixa then do:
        ...
        find es-acordo-area no-lock where
             es-acordo-area.cod-area = es-acordo-faixa.cod-area no-error.
        ...
        find es-tipo-docto no-lock where 
             es-tipo-docto.tp-docto = es-acordo-faixa.tp-docto no-error.
