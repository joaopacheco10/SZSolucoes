...
*******************************************************************************/
{include/i-prgvrs.i ESCM104B 12.01.00.001}
...
DEFINE VARIABLE h_escm104-q02 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_escm104b-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 7.25 COL 2.57 HELP
          "Salva e sai"
     bt-save AT ROW 7.25 COL 13 HELP
          "Salva e cria novo"
     bt-cancela AT ROW 7.25 COL 23.57 HELP
          "Cancela"
     bt-ajuda AT ROW 7.25 COL 70.72
     rt-button AT ROW 7.08 COL 1.57
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 80.57 BY 17 WIDGET-ID 100.
...
DO:
{include/okfil.i h_escm104b-v01}
END.
...
DO:
{include/salvafil.i h_escm104b-v01}
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/escm104b-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_escm104b-v01 ).
       RUN set-position IN h_escm104b-v01 ( 1.17 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 5.75 , 77.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/escm104-q02.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_escm104-q02 ).
       RUN set-position IN h_escm104-q02 ( 6.92 , 59.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.50 , 6.00 ) */

       /* Links to SmartViewer h_escm104b-v01. */
       RUN add-link IN adm-broker-hdl ( h_escm104-q02 , 'Record':U , h_escm104b-v01 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_escm104b-v01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_escm104b-v01 ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESCM104B" "12.01.00.001"}

  /* Dispatch standard ADM method.                             */
  RUN dispatch IN THIS-PROCEDURE ( INPUT 'initialize':U ) .

  run pi-atualiza-parent in h_escm104b-v01 (input v-row-parent).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_escm104-q02 (input v-row-table).
