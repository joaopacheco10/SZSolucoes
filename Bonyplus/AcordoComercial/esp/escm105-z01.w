...
*******************************************************************************/
{include/i-prgvrs.i ESCM105-Z01 12.01.00.001}
...
DEFINE VARIABLE h_escm105-b02 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/escm105-b02.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_escm105-b02 ).
       RUN set-position IN h_escm105-b02 ( 3.75 , 6.57 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 80.14 ) */

       /* Links to SmartBrowser h_escm105-b02. */
       RUN add-link IN adm-broker-hdl ( h_escm105-b02 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_escm105-b02 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESCM105-Z01" "12.01.00.001"}
