...
*******************************************************************************/
{include/i-prgvrs.i ESCM105A 12.01.00.001}
...
DEFINE VARIABLE h_escm105-v02 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_escm105a-q01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 7.13 COL 2.57 HELP
          "Salva e sai"
     bt-save AT ROW 7.13 COL 13 HELP
          "Salva e cria novo"
     bt-cancela AT ROW 7.13 COL 23.57 HELP
          "Cancela"
     bt-ajuda AT ROW 7.13 COL 70.72
     rt-button AT ROW 6.96 COL 1.43
...
DO:
{include/salvafil.i h_escm105-v02}
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/escm105-v02.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_escm105-v02 ).
       RUN set-position IN h_escm105-v02 ( 1.08 , 1.29 ) NO-ERROR.
       /* Size in UIB:  ( 5.75 , 80.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/escm105a-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_escm105a-q01 ).
       RUN set-position IN h_escm105a-q01 ( 6.83 , 56.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartViewer h_escm105-v02. */
       RUN add-link IN adm-broker-hdl ( h_escm105a-q01 , 'Record':U , h_escm105-v02 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_escm105-v02 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_escm105-v02 ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESCM105A" "12.01.00.001"}

  /* Dispatch standard ADM method.                             */
  RUN dispatch IN THIS-PROCEDURE ( INPUT 'initialize':U ) .

  run pi-atualiza-parent in h_escm105-v02 (input v-row-parent).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_escm105a-q01 (input v-row-table).
