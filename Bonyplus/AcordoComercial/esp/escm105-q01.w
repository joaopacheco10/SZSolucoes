...
*******************************************************************************/
{include/i-prgvrs.i ESCM105-Q01 12.01.00.001}
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-acordo-faixa NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-acordo-faixa NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main es-acordo-faixa
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-acordo-faixa
