...
*******************************************************************************/
{include/i-prgvrs.i ESCM104-Q01 12.01.00.001}
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-acordo-area-docto NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-acordo-area-docto NO-LOCK INDEXED-REPOSITION.
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "mgesp.es-acordo-area-docto"
