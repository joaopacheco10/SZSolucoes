...
*******************************************************************************/
{include/i-prgvrs.i ESCM105 12.01.00.001}
...
DEFINE VARIABLE h_escm105-b01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_escm105-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_escm105-v01 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/escm105-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_escm105-v01 ).
       RUN set-position IN h_escm105-v01 ( 2.50 , 1.72 ) NO-ERROR.
       /* Size in UIB:  ( 5.25 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'adm/objects/folder.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'FOLDER-LABELS = ':U + 'Aprovadores' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 7.83 , 1.00 ) NO-ERROR.
       RUN set-size IN h_folder ( 9.83 , 90.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/escm105-b01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = ?,
                     ProgAtributo = ,
                     ProgIncMod = esp/escm105a.w,
                     MessageNum = 0,
                     MessageParam = ':U ,
             OUTPUT h_escm105-b01 ).
       RUN set-position IN h_escm105-b01 ( 9.75 , 11.72 ) NO-ERROR.
       /* Size in UIB:  ( 7.50 , 67.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/escm105-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = esp/escm105-z01.w,
                     ProgVaPara = esp/escm105-g01.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_escm105-q01 ).
       RUN set-position IN h_escm105-q01 ( 1.00 , 63.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.25 , 5.00 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , THIS-PROCEDURE ).

       /* Links to SmartViewer h_escm105-v01. */
       RUN add-link IN adm-broker-hdl ( h_escm105-q01 , 'Record':U , h_escm105-v01 ).

       /* Links to SmartFolder h_folder. */
       RUN add-link IN adm-broker-hdl ( h_folder , 'Page':U , THIS-PROCEDURE ).

       /* Links to BrowserCadastro2 h_escm105-b01. */
       RUN add-link IN adm-broker-hdl ( h_escm105-q01 , 'Record':U , h_escm105-b01 ).

       /* Links to SmartQuery h_escm105-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_escm105-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_escm105-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_escm105-q01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-navega ,
             h_p-exihel , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_escm105-v01 ,
             h_p-navega , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_folder ,
             h_escm105-v01 , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_escm105-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESCM105" "12.01.00.001"}
