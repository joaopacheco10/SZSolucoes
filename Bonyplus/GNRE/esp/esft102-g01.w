...
*******************************************************************************/
{include/i-prgvrs.i ESFT102-G01 12.01.00.001}
...
&Scoped-Define ENABLED-OBJECTS rt-button c_cod-lote bt-ok bt-cancela ~
bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS c_cod-lote 
...
DEFINE VARIABLE c_cod-lote AS CHARACTER FORMAT "x(12)":U 
     LABEL "Lote GNRE" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME d-vapara
     c_cod-lote AT ROW 2 COL 30 COLON-ALIGNED WIDGET-ID 2
...
DO:
FIND es-lote-gnre NO-LOCK
    WHERE es-lote-gnre.cod-lote EQ INPUT FRAME {&FRAME-NAME} c_cod-lote NO-ERROR.

IF NOT AVAILABLE es-lote-gnre THEN DO:
    {utp/ut-table.i mgesp es-lote-gnre 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(es-lote-gnre).
END.
...
------------------------------------------------------------------------------*/
  DISPLAY c_cod-lote 
      WITH FRAME d-vapara.
  ENABLE rt-button c_cod-lote bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESFT102-G01" "12.01.00.001"}
