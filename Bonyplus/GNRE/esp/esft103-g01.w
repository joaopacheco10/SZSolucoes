...
*******************************************************************************/
{include/i-prgvrs.i ESFT103-G01 12.01.00.001}
...
&Scoped-Define ENABLED-OBJECTS rt-button c_cod-uf i_cod-receita bt-ok ~
bt-cancela bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS c_cod-uf i_cod-receita 
...
DEFINE VARIABLE c_cod-uf AS CHARACTER FORMAT "x(4)":U 
     LABEL "UF" 
     VIEW-AS FILL-IN 
     SIZE 6 BY .88 NO-UNDO.

DEFINE VARIABLE i_cod-receita AS INTEGER FORMAT "999999":U 
     LABEL "Receita" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME d-vapara
     c_cod-uf AT ROW 1.5 COL 30 COLON-ALIGNED WIDGET-ID 2
     i_cod-receita AT ROW 2.5 COL 30 COLON-ALIGNED WIDGET-ID 4
...
DO:
FIND es-conf-uf-gnre NO-LOCK
    WHERE es-conf-uf-gnre.cod-uf EQ INPUT FRAME {&FRAME-NAME} c_cod-uf
      AND es-conf-uf-gnre.cod-receita EQ INPUT FRAME {&FRAME-NAME} i_cod-receita NO-ERROR.

IF NOT AVAILABLE es-conf-uf-gnre THEN DO:
    {utp/ut-table.i mgesp es-conf-uf-gnre 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(es-conf-uf-gnre).
END.
...
------------------------------------------------------------------------------*/
  DISPLAY c_cod-uf i_cod-receita 
      WITH FRAME d-vapara.
  ENABLE rt-button c_cod-uf i_cod-receita bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESFT103-G01" "12.01.00.001"}
